...
type PageState = 'FORM' | 'LOADING' | 'QR_CODE' | 'ERROR';
    ...
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-md mx-auto">
        <RifaCard
            ...
            valorTotal={0} // This should be calculated based on rifa.valorCota
        ...
        <div className="mt-8">
            {pageState === 'FORM' && (
                <FormularioCheckout onSubmit={handleCheckoutSubmit} isLoading={pageState === 'LOADING'} />
            )}
            {pageState === 'LOADING' && (
            ...
            {pageState === 'QR_CODE' && qrCodeData && (
                <QrCodeDisplay {...qrCodeData} />
            )}
